    ...
    <section className="relative h-[100dvh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl pt-16 md:pt-0">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white mb-6 leading-[1.1] md:leading-[1.1] [text-shadow:0_2px_10px_rgba(0,0,0,0.4)]">
          ...
          <p className="text-lg md:text-2xl text-white/95 mb-10 max-w-3xl mx-auto font-medium tracking-wide [text-shadow:0_2px_8px_rgba(0,0,0,0.4)]">
